...
// THIS ENTIRE FILE IS COPIED FROM HERE:
// https://github.com/tyler-smith/go-bip39/blob/master/bip39.go
// In order to minimize external dependencies in this sensitive project.
// The only change is hardcoding the language to English.

// The original file is licensed under the MIT License.
// Thank you Tyler Smith for implementing this.
